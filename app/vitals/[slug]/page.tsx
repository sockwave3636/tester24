...
export default async function VitalDetailPage({ params }: VitalPageProps) {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#f8fafc_0%,#f1f5f9_45%,#eef2f7_100%)] p-6 md:p-10">
      <div className="mx-auto w-full max-w-5xl rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-2xl shadow-slate-200/70 backdrop-blur md:p-8">
